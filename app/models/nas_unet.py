...
class NasUnet(BaseNet):
    ...
    def __init__(self, out_channels, in_channels, backbone=None, aux=False,
                 c=48, depth=5, dropout_prob=0,
                 genotype=None, double_down_channel=False):

        super(NasUnet, self).__init__(out_channels, aux, backbone, norm_layer=nn.GroupNorm)
        self._depth = depth
        ...
        self.nas_unet_head = ConvOps(c_prev, out_channels, kernel_size=1, ops_order='weight')
